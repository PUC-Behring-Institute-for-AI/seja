def register_tools(mcp):
    ...
    PERSPECTIVES = [
        {"id": "p1", "name": "Semiotic Perfection", "depth": 3, "depth_factor": 3,
         "questions": [
